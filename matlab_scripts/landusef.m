...
cd('H:\Program Files\MATLAB\R2008a\work\m_map') 
%去到m_proj、m_pcolor、m_plotbndry、m_grid等m文件的存放目录（按实际情况填写）
...
m_proj('Lambert Conformal Conic','lon',rang_lon1,'lat',rang_lat1,'clo',113.7,'par',[20 25.7],'rec','on');
%按实际情况设定投影情况
