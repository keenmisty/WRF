...
ncpath=strcat('/ees/users/EMG/ees2/weihua/WRF/3.4.1/wrfchem/test/haze.201210.8-15/'); 
...
pv=Qv2Pv(q2,press);
ws=sqrt(u10.^2+v10.^2);
save('8-15mettime.mat','t2','ws','u10','v10','press','pv','sw','rh');
...
save('8-15gas.mat','so2','no2','no','o3','co');  
...
pm25_p1=pm25_p1(:,:,:,:);
pm25_p2=pm25_p2(:,:,:,:);
save('8-15particle.mat','pm10','pm25','pm25_p1','pm25_p2');
...
save('8-15seconadarychemical.mat','so4_1','so4_2','so4_3','so4_4','so4_5','so4_6','so4_7','so4_8',...
...
save('8-15OCECchemical.mat','bc_1','bc_2','bc_3','bc_4','bc_5','bc_6','bc_7','bc_8',...
